...
class XML_RoBERTa(torch.nn.Module):
    def __init__(self, num_labels=6):
        ...
        self.config = AutoConfig.from_pretrained("xlm-roberta-base", num_labels=6)
...
def ValidateXMLRoBERTa(temp_model):
...
def TrainXMLRoBERTa():
    ...
    for epoch in range(20):
        ...
        if accuracy > best_accuracy:
            ...
            best_model = model
    torch.save(best_model, "./mmbtc-6-model/BenEngBest_XML_RoBERTa_model.pt")
