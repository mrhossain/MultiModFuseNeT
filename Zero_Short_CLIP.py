...
from transformers import CLIPModel, CLIPProcessor, AutoConfig, pipeline
...
if __name__ == "__main__":
    ...
    categories = ["Business", "Crime", "Entertainment", "Environment", "Science-Tech", "Others"]
    pred_labels = []
    actual_labels = []
